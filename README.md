...
| 选项 | 说明 |
|------|------|
| 下拉邮箱源 | CF Worker / cloudflare_temp_email / MoeMail / TempMail.lol / DuckMail / GPTMail / MaliAPI(YYDS) / LuckMail / SkyMail / CloudMail / Freemail / OpenTrashMail / Laoudo |
| 自建推荐 | CF Worker 或 cloudflare_temp_email：API 根地址 / Key / 域名 / 路径 |
...
- **多邮箱源下拉**：接入 any-auto-register 全套邮箱/接码源（CF Worker、MoeMail、TempMail.lol、DuckMail、GPTMail、LuckMail、MaliAPI 等）
